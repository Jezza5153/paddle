...
export const metadata: Metadata = {
  title: "Algemene Voorwaarden | CourtStart NL",
  description: "Algemene voorwaarden van CourtStart NL.",
};
        ...
        <div className="content-width">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-text-secondary leading-7">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>CourtStart NL</strong>: de ondernemer, gevestigd in Nederland</li>
              <li><strong>Klant</strong>: de natuurlijke persoon die een overeenkomst aangaat met CourtStart NL</li>
            ...
            <p>Deze voorwaarden zijn van toepassing op alle bestellingen via courtstart.nl.</p>
            ...
            <p>De levertijd staat vermeld bij elk product. CourtStart NL streeft ernaar binnen de aangegeven termijn te leveren, maar kan niet aansprakelijk worden gesteld voor vertragingen door de vervoerder.</p>
            ...
            <p>CourtStart NL is niet aansprakelijk voor schade die voortvloeit uit het gebruik van de producten, tenzij er sprake is van opzet of grove nalatigheid.</p>

            <h2 className="text-lg font-semibold text-text-primary mt-8">Artikel 8 — Klachten</h2>
            <p>Klachten kunnen worden ingediend via <a href="mailto:info@courtstart.nl" className="text-brand-green hover:underline">info@courtstart.nl</a>. We streven ernaar binnen 5 werkdagen te reageren.</p>
