...
export const products: ProductData[] = [
  ...
  {
    id: "cj_racket_bag_01",
    slug: "padel-racket-tas-eva",
    name: "Padel Racket Tas (EVA Hardshell)",
    shortDescription: "Stevige EVA hardshell racket tas. Beschermt je racket onderweg.",
    description: "Bescherm je padel racket met deze stevige EVA hardshell tas. Stofvrij, schokbestendig en voorzien van een handige draagriem. Past op alle standaard padel rackets.",
    status: "active",
    basePriceIncVat: 19.95,
    compareAtPriceIncVat: 29.95,
    primaryImage: "/images/products/1pc-table-tennis-racket-bags-eva-hard-shell-high-quality-dustproof-table-tennis-paddles-box-case-storage-bag-with-hand-strap-good-2032.jpg",
    galleryImages: ["/images/products/1pc-table-tennis-racket-bags-eva-hard-shell-high-quality-dustproof-table-tennis-paddles-box-case-storage-bag-with-hand-strap-good-2032.jpg"],
    brand: "PaddleForge",
    category: "Paddle Accessoires",
    badge: "Nieuw",
    shippingEstimateMinDays: 6,
    shippingEstimateMaxDays: 12,
    returnWindowDays: 14,
    contents: ["1x EVA hardshell racket tas"],
    bulletPoints: ["EVA hardshell — schokbestendig", "Stofvrij opbergen", "Universele pasvorm", "Handige draagriem"],
    faq: [{ question: "Past mijn racket hierin?", answer: "Ja, de tas past op alle standaard padel rackets tot 46cm." }],
    cjProductId: "2032008201040740353",
    cjVariantId: "CJSD2785213",
    cjSku: "CJSD2785213",
    cjCostUsd: 11.14,
  },
  {
    id: "cj_pro_racket_bag_01",
    slug: "pro-padel-racket-case",
    name: "Pro Padel Racket Case",
    shortDescription: "Professionele EVA racket case met extra opbergvak.",
    description: "Professionele EVA hardshell racket case met extra opbergvak voor accessoires. Ideaal voor spelers die hun uitrusting altijd bij zich hebben.",
    status: "active",
    basePriceIncVat: 22.95,
    compareAtPriceIncVat: 34.95,
    primaryImage: "/images/products/1pc-professional-table-tennis-rackets-eva-hard-shell-table-tennis-paddle-case-table-tennis-paddles-box-case-storage-bag-2032.jpg",
    galleryImages: ["/images/products/1pc-professional-table-tennis-rackets-eva-hard-shell-table-tennis-paddle-case-table-tennis-paddles-box-case-storage-bag-2032.jpg"],
    brand: "PaddleForge",
    category: "Paddle Accessoires",
    badge: null,
    shippingEstimateMinDays: 6,
    shippingEstimateMaxDays: 12,
    returnWindowDays: 14,
    contents: ["1x professionele EVA racket case"],
    bulletPoints: ["Extra opbergvak", "Premium EVA materiaal", "Lichtgewicht en stevig"],
    faq: [{ question: "Hoeveel rackets passen erin?", answer: "De case is ontworpen voor 1 racket met ruimte voor accessoires." }],
    cjProductId: "2032008146193903618",
    cjVariantId: "CJSD2785211",
    cjSku: "CJSD2785211",
    cjCostUsd: 12.34,
  },
  {
    id: "cj_pro_racket_set_01",
    slug: "pro-racket-set-carbon",
    name: "Pro Carbon Racket Set (2 stuks)",
    shortDescription: "Professioneel carbon fiber racket set voor 2 spelers. Hoge elasticiteit.",
    description: "Professioneel 7-laags carbon fiber racket set met hoge elasticiteit. Ideaal voor competitieve spelers die op zoek zijn naar maximale prestaties. Set van 2 rackets.",
    status: "active",
    basePriceIncVat: 49.95,
    compareAtPriceIncVat: 69.95,
    primaryImage: "/images/products/6-star-7-ply-genuine-professional-table-tennis-racket-double-racket-straight-and-penhold-handles-authentic-carbon-fiber-competition-table-tennis-racket-high-elasticity-set-2032.jpg",
    galleryImages: ["/images/products/6-star-7-ply-genuine-professional-table-tennis-racket-double-racket-straight-and-penhold-handles-authentic-carbon-fiber-competition-table-tennis-racket-high-elasticity-set-2032.jpg"],
    brand: "PaddleForge",
    category: "Paddle Sets",
    badge: "Bestseller",
    shippingEstimateMinDays: 6,
    shippingEstimateMaxDays: 12,
    returnWindowDays: 14,
    contents: ["2x 7-laags carbon fiber rackets", "Draagtas"],
    bulletPoints: ["7-laags carbon fiber constructie", "Hoge elasticiteit", "Set voor 2 spelers", "Competitie-niveau"],
    faq: [{ question: "Is dit geschikt voor beginners?", answer: "Dit is een geavanceerd set, maar ook beginners kunnen er goed mee starten." }],
    cjProductId: "2032005332757561345",
    cjVariantId: "CJSD2785137",
    cjSku: "CJSD2785137",
    cjCostUsd: 12.18,
  },
  {
    id: "cj_net_stand_01",
    slug: "draagbaar-net-standaard",
    name: "Draagbaar Net Standaard",
    shortDescription: "Portable netstandaard voor padel en tennis. Stevig en vrijstaand.",
    description: "Stevige draagbare netstandaard voor padel en tennis. Vrijstaand ontwerp met zwaar materiaal voor stabiliteit. Snel op te zetten en mee te nemen.",
    status: "active",
    basePriceIncVat: 12.95,
    compareAtPriceIncVat: 19.95,
    primaryImage: "/images/products/table-tennis-net-stand-portable-free-standing-heavy-duty-material-2603.jpg",
    galleryImages: ["/images/products/table-tennis-net-stand-portable-free-standing-heavy-duty-material-2603.jpg"],
    brand: "PaddleForge",
    category: "Nets & Velden",
    badge: null,
    shippingEstimateMinDays: 6,
    shippingEstimateMaxDays: 12,
    returnWindowDays: 14,
    contents: ["1x draagbare netstandaard"],
    bulletPoints: ["Vrijstaand ontwerp", "Stevig materiaal", "Snel op te zetten"],
    faq: [{ question: "Is dit geschikt voor buiten?", answer: "Ja, de standaard is geschikt voor zowel binnen- als buitengebruik." }],
    cjProductId: "2603100546551611600",
    cjVariantId: "CJYD2782230",
    cjSku: "CJYD2782230",
    cjCostUsd: 1.93,
  },
  {
